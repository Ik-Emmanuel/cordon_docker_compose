...
const AccessingData = () => {
  return (
    <div id="faq" className="container mx-auto lg:px-20 my-20">
      <h2 className="mb-20 text-cordon-4 text-center text-3xl tracking-tighter sm:text-4xl lg:text-4xl font-semibold">
          ...
          <AccordionItem key={index} value={faq.value}>
            <AccordionTrigger className="font-semibold hover:no-underline">
              <div className="flex gap-4 text-left ">
                <Info className="text-cordon_sec-2" /> {faq.question}
              </div>
            </AccordionTrigger>
